...
CREATE TABLE `agroquimicos` (
  ...
  `unidad_dosis` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `auditoria` (
  ...
  `tipo_operacion` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `bodegas` (
  ...
  `tipo_almacenamiento` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `recepcion_acopio` (
  ...
  `estado_producto` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `operario_id` int DEFAULT NULL,
  `observaciones` text COLLATE utf8mb4_unicode_ci,
  `fecha_creacion` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `semillas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre_variedad` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `trazabilidad` (
  `id` int NOT NULL AUTO_INCREMENT,
  `lote_id` int NOT NULL,
  `codigo_trazabilidad` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2026-04-19 16:17:50
